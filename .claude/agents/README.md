...
- **[dead-code-detector](./dead-code-detector.md)** - Unused code identification, unreferenced functions, and dead import cleanup
...
```bash
ls ~/.claude/agents/
# Should show all 26 agent files
```
...
| Dead Code Cleanup | `dead-code-detector` | `refactoring-expert` |
