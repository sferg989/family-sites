...
- **dead-code-detector**: Unused code identification, unreferenced function removal, dead import cleanup
...
- **Unused Code Cleanup** → dead-code-detector + refactoring-expert
